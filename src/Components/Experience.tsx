    ...
    return items.map((item: any, index: number) => (
        ...
        >
            <div className="border shadow-[0_0_10px_0_var(--primary-color)] hover:-translate-y-2 transition transform duration-300 ease-in-out flex flex-col gap-2 border-primaryColor p-4 rounded-2xl sm-mx:p-2">
                ...
                <img className="rounded-lg w-16 md-mx:w-14" src={item.image} alt="Company Logo" />
...
const Education = () => {
    ...
    return (
        <div className="px-16 mx-20 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Education">
            ...
            <Timeline color="var(--primary-color)" active={2} bulletSize={dot} lineWidth={2}>
                {TimelineItem(ExperienceInfo.filter((item:any) => item.company === "Student"))}
